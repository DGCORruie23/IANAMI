...
DEBUG = os.environ.get("DEBUG", "1").strip().split('#')[0].strip().lower() in ("true", "1", "yes", "on")


ALLOWED_HOSTS = os.environ.get("DJANGO_ALLOWED_HOSTS", default='192.168.0.21').split(" ")
...
LOGIN_URL = 'login'
LOGIN_REDIRECT_URL = 'inteligencia'
